  ...
  render() {
    return (
      <div>
        ...
        <Link className="subnav_links" to="/about"><div>About</div></Link>
        <Link className="subnav_links" to="/about/history"><div>History</div></Link>
        <Link className="subnav_links" to="/about/contact"><div>Contact</div></Link>
        </div>
